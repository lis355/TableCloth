...
{/*
    static class FCheck
    {
        ...
        {
            if (F.CaclOnBoolVector(new bool[F.VariableCount]) == false) return "True"; else return "False";
        }
        ...
        static public string BelongTOne(ref Formula F)
        {
            ...
            if (F.CaclOnBoolVector(b) == true) return "True"; else return "False";
        }
        ...
        static public string BelongS(ref Formula F)
        {
            ...
            if (F.VariableCount == 0) return "False";
        ...
        static public string FullSystem(ref Formula[] FArray)
        {
            ...
            {
                if (belongt0) if (BelongTZero(ref FArray[i]) != "True") belongt0 = false;
                if (belongt1) if (BelongTOne(ref FArray[i]) != "True") belongt1 = false;
                if (belongs) if (BelongS(ref FArray[i]) != "True") belongs = false;
                if (belongm) if (BelongM(ref FArray[i]) != "True") belongm = false;
                if (belongl) if (BelongL(ref FArray[i]) != "True") belongl = false;
                if ((belongt0 || belongt1 || belongs || belongm || belongl) == false) return "True";
            }
            return "False"; 
        }
        ...
        {
            if (FArray.Length > 4) return "False";
            ...
            for (int i = 0; i < FArray.Length; i++)
            {
                if (BelongTZero(ref FArray[i]) == "True") M[i, 0] = true;
                else M[i, 0] = belongt0 = false;
                if (BelongTOne(ref FArray[i]) == "True") M[i, 1] = true;
                else M[i, 1] = belongt1 = false;
                if (BelongS(ref FArray[i]) == "True") M[i, 2] = true;
                else M[i, 2] = belongs = false;
                if (BelongM(ref FArray[i]) == "True") M[i, 3] = true;
                else M[i, 3] = belongm = false;
                if (BelongL(ref FArray[i]) == "True") M[i, 4] = true;
