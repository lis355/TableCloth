...
class Scanner {
    ...
    public Scanner (string inputString) {
        MemoryStream stream = new MemoryStream(System.Text.Encoding.Default.GetBytes(inputString));
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 3:
				{t.kind = 3; break;}
			case 4:
				if (ch == 'o') {AddCh(); goto case 5;}
				else {goto case 0;}
			case 5:
				if (ch == 't') {AddCh(); goto case 6;}
				else {goto case 0;}
			case 6:
			...
			case 37:
				if (ch == 's') {AddCh(); goto case 38;}
				else {goto case 0;}
			case 38:
				if (ch == 'e') {AddCh(); goto case 39;}
				else {goto case 0;}
			case 39:
			...
			case 48:
				...
				else if (ch == 'i') {AddCh(); goto case 25;}
				else if (ch == 's') {AddCh(); goto case 30;}
				else if (ch == 'p') {AddCh(); goto case 35;}
				else {goto case 0;}
