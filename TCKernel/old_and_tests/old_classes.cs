...
//{
    /*
    enum FunctionTypeOLD : byte
    {
        FunctionWithOneParameter,
        FunctionWithOneParameterAndCanUseInExpression,
        FunctionWithManyParameters,
        FunctionWithManyParametersAndCanUseInExpression,
        FunctionOnVariable,
        SystemFunction
    }
    */
    ...
    /*
        static class CorrectFunctionNamesOLD
        {
...
//                         };
    ...
    /// </summary>
    static bool CalcSimplyString(string S, ref string OutString, ref Formula Ans, bool EquateToVar)
    {
...
//                          * x > x = 1
    ...
    */
    ...
    /// </summary>
    internal static void AddCommands(SpecialSymbol S, ref Formula Ans)
    {
        if (S.Symbol == '0')
        {
